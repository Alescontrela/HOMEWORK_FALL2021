...
class ReplayBuffer(object):
    ...
    def sample_random_data(self, batch_size):
        ...
        sample_idxs = np.random.permutation(self.obs.shape[0])[:batch_size]
        return self.obs[sample_idxs], self.acs[sample_idxs], self.rews[sample_idxs], self.next_obs[sample_idxs], self.terminals[sample_idxs]
