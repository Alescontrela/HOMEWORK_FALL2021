...
from cs285.infrastructure import utils_multiprocessing
...
class RL_Trainer_Multi(object):
    ...
    def __init__(self, params):
        ...
        num_parallel_envs = 6
        self.envs = [gym.make(self.params['env_name']) for _ in range(num_parallel_envs)]
        ...
        if params['action_noise_std'] > 0:
            ...
            for i in range(num_parallel_envs):
                self.envs[i] = ActionNoiseWrapper(self.envs[i], seed, params['action_noise_std'])
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, batch_size):
        ...
        paths, envsteps_this_batch = utils_multiprocessing.sample_trajectories(
            self.envs, collect_policy, batch_size, self.params['ep_len'])
    ...
    def train_agent(self):
        ...
        for train_step in range(self.params['num_agent_train_steps_per_iter']):
            ...
            # print(ac_batch)
            # print(len(ac_batch), self.params['train_batch_size'])
